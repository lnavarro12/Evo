...
// usuario.controller('controllerBusqueda', ['$scope',"$http", '$routeParams','$location',function($scope,$http,$routeParams,$location){
// 	$scope.usuarios = [];
//   $scope.buscarRegistro = function(tipoBusqueda,keyword){
// 		// //console.log(tipoBusqueda+" "+keyword);
// 		var key = normalize(keyword);
// 		$location.path("/resultadoBusqueda/"+ tipoBusqueda+ "/" +key);
//     // location.href = "/login";
//     // location.href = "/resultadoBusqueda";
// 	}

// 	var url = $location.path();
// 	if(url.indexOf('/resultadoBusqueda')!=-1){
// 		// Se envia por parámetros las opciones de búsqueda que el usuario escogio
// 		// Búsqueda por Contrato
// 		// Búsqueda por Cargo
// 		// Búsqueda por nombre
// 		$http.get("/usuarios/busqueda", {
// 			params: {
// 				tipoBusqueda: $routeParams.tipoBusqueda,
...
//   				// var n = $scope.usuarios.length;
// 	  			// if (n > 0) {
//   					$scope.usuarios = response.data.usuarios;
// 	  			// }else{
// 	  			// 	$scope.usuarios = "No hay registros disponibles";
// 	  			// }
//   			}
//   		});
// 	}
